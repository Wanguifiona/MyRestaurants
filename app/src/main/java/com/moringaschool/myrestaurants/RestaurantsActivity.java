...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    private String [] cuisines = new String [] {"Vegan Food", "Breakfast", "Fish Dishs", "Scandinavian", "Coffee", "English Food", "Burgers", "Fast Food", "Noodle Soups", "Mexican", "BBQ", "Bar Food", "Sports Bar", "Breakfast", "Mexican"};
